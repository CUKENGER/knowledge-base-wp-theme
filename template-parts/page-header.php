...
<div class='page-header__contents-menu' id="contents-menu">
    <div class='page-header__contents-list'>
        ...
        foreach ($categories as $category):
            ...
            ?>
            <button class="category-widget__title<?php echo esc_attr($is_active); ?>" data-category-id="<?php echo esc_attr($category->term_id); ?>">
                <p class="category-widget__content--title">
                    <?php echo esc_html($category->name); ?>
                    <span class="category-widget__count--title"><?php echo esc_html($post_count); ?></span>
                </p>
                <svg class="category-widget__arrow" width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 2L8 6L13 2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </button>
            <div class="category-widget__post-list" data-category-id="<?php echo esc_attr($category->term_id); ?>" style="display: <?php echo esc_attr($display); ?>;">
                <?php
                $posts = get_posts([
                ...
                foreach ($posts as $post):
                    ...
                    ?>
                    <a href="<?php echo esc_url(get_permalink($post->ID)); ?>" class="card-btn <?php echo esc_attr($is_post_active); ?>">
    ...
    <div class='page-header__wrapper'>
        ...
        <div class='page-header__input-container'>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10.5 3C14.6421 3 18 6.35786 18 10.5C18 12.2105 17.4259 13.7861 16.4619 15.0479L20.707 19.293L20.7754 19.3691C21.0957 19.7619 21.0731 20.3409 20.707 20.707C20.3409 21.0731 19.7619 21.0957 19.3691 20.7754L19.293 20.707L15.0479 16.4619C13.7861 17.4259 12.2105 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3ZM10.5 5C7.46243 5 5 7.46243 5 10.5C5 13.5376 7.46243 16 10.5 16C13.5376 16 16 13.5376 16 10.5C16 7.46243 13.5376 5 10.5 5Z" fill="#ABB0BA" />
            </svg>
...
<svg aria-hidden="true" style="position: absolute; width: 0; height: 0; overflow: hidden;">
    <defs>
        <symbol id="chevron-icon" viewBox="0 0 8 16">
            <path d="M2 3L6 8L2 13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none" />
        </symbol>
    </defs>
</svg>